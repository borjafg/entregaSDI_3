...
import uo.sdi.client.dto.UserNoPasswordDTO;
import uo.sdi.client.rest.exceptions.FailToAuthorizedException;
import uo.sdi.client.rest.util.Authenticator;
import uo.sdi.client.rest.util.Encryptor;
...
public class RestClient {
	...
	if (respuesta.getStatusInfo().getStatusCode() == Response.Status.ACCEPTED
	    ...
	    ErrorDTO error = respuesta.readEntity(ErrorDTO.class);
